    ...
    public JSONObject authenticate(AuthenticationRequest request) {
        ...
        if (user.getUserKind() == UserKind.SHOP)            //User Shop
        {
            if (user.getRole() == ADMIN) {
                ...
                checkBoxesList=new String[]{};//"chk1","chk2","chk3"};
                panels=new String[][]{{"نحوه ارسال","نحوه دریافت","دستور","نوع"},{"صدا","تصویر","صداوتصویر","هیچکدام"},{"صدا","تصویر","صداوتصویر","هیچکدام"},{"ثبت","تسویه","گزارش کالا"+"گزارش فاکتور"},{"فروشنده"+"خریدار"}};
        ...
        else if (user.getUserKind() ==UserKind.TEST )
        {
            ...
            checkBoxesList=new String[]{"chk1","chk2","chk3"};
            panels=new String[][]{{"نحوه ارسال","پاسخ دریافتی","پنل 3","پنل 4"},{"صدا","عکس","صداوعکس","هیچکدام"},{"صدا","عکس","صداوعکس","هیچکدام"},{"رادیو باتن 1","رادیو باتن 2"},{"رادیو باتن 1","رادیو باتن 2"}};
